...
This matrix connects target-role capabilities to repository evidence and identifies what remains to be built. It is not a substitute for professional experience documented on the resume.

## Salesforce JR346211 — AI Forward-Deployed Engineer

| Capability | Repository evidence | Current strength | Remaining proof |
|---|---|---|---|
...
## VTG / Navy AI Architect

| Capability | Repository evidence | Current strength | Remaining proof |
|---|---|---|---|
| Agentic AI, autonomous and semi-autonomous workflows | Typed orchestrator, policy decisions, action proposals, approval boundary | Strong pattern evidence | Add credentialed multi-agent and durable workflow comparison |
| RAG and LLM applications | BM25 retrieval, grounded provider, provider interfaces | Strong RAG workflow pattern | Add real model benchmarks and dense/hybrid retrieval comparison |
| Evaluation, validation, benchmarking | Deterministic benchmark, report metadata, red-team suite | Strong baseline | Add Ragas/DeepEval, claim-level citations, failure taxonomy, human review |
| Adversarial testing and hallucination controls | Prompt-injection, secrets, destructive-action tests; groundedness proxy | Strong baseline | Add broader attack corpus, LLM-specific jailbreak tests, incident severity |
...
5. one real cloud deployment;
6. comparable OpenAI and Microsoft framework adapters.
